...
export const metadata: Metadata = {
  title: "The No.1 Tattoo Service in King City | Custom Tattoos | AMAX Tattoo",
  description:
    "AMAX Tattoo Studio — the #1 tattoo service in King City, Ontario. Custom tattoos, fine line, black and grey, realism, and sleeve tattoos. Book your appointment today.",
  keywords: [
    "tattoo king city ontario",
    "tattoo studio king city",
    "custom tattoo king city",
    "fine line tattoo king city",
    "black and grey tattoo king city",
    "realism tattoo king city",
    "tattoo appointment king city ontario",
  ],
  alternates: { canonical: `${siteConfig.domain}/locations/king-city` },
  openGraph: {
    title: "The No.1 Tattoo Service in King City | AMAX Tattoo",
    description: "Custom tattoos, fine line, realism, and sleeve tattoos in King City. Professional studio, by appointment.",
  },
};
...
export default function KingCityPage() {
  const nearbyLocations = serviceLocations.filter((l) => l.slug !== "king-city").slice(0, 6);
      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-3xl">
          ...
          <div className="inline-flex items-center gap-2 rounded-full border border-violet-500/25 bg-violet-500/10 px-4 py-1.5 text-[10px] font-semibold uppercase tracking-[0.3em] text-violet-400">
            ...
            Ontario, Canada · ~15 km from Aurora
          </div>
          ...
          <h1 className="font-display mt-3 text-4xl font-bold text-white sm:text-5xl lg:text-6xl leading-tight">
            The #1 Tattoo Service in{" "}
            <span className="gradient-text italic">King City</span>
          </h1>
          ...
          <p className="mt-6 mx-auto max-w-2xl leading-relaxed text-white/75">
            A professional studio dedicated to providing quality service, customer care, and a safe,
            clean environment for tattoos and piercings. Known for our good reputation — we focus on
            creativity, precision, and custom tattoo designs that reflect your personal style and story.
          </p>
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <h2 className="font-display mt-3 text-4xl font-bold text-white sm:text-5xl">
              Custom Tattoos{" "}
              <span className="gradient-text italic">Designed for You</span>
            </h2>
            <p className="mt-6 leading-relaxed text-white/65">
              AMAX Tattoo Studio is a professional studio dedicated to providing quality service,
              customer care, and a safe, clean environment for tattoos and piercings in King City.
              Our artists work closely with each client to transform ideas into unique tattoos.
            </p>
            <p className="mt-4 leading-relaxed text-white/50">
              Every design is carefully planned to ensure the right size, placement, and artistic
              balance. Whether you want a fine line tattoo, black and grey, realism, minimalist, or
              a custom sleeve — our goal is to create tattoos that look clean, timeless, and
              professionally crafted.
            </p>
          </div>
          <div className="glass rounded-2xl p-6 sm:p-8">
            <p className="text-xs font-semibold uppercase tracking-[0.3em] text-violet-400 mb-4">Tattoo Styles in King City</p>
      ...
      <section className="sec-dark mx-auto w-full max-w-5xl px-4 py-24 sm:px-6 lg:px-8">
        <div className="mb-12">
          ...
          <h2 className="font-display mt-3 text-4xl font-bold text-white sm:text-5xl">
            ...
            <span className="gradient-text italic">in King City</span>
          </h2>
          <p className="mt-4 max-w-2xl leading-relaxed text-white/55">
            Clients looking for tattoo services in King City choose AMAX Tattoo Studio for custom
            artwork and professional tattoo techniques. Our studio focuses on quality craftsmanship
            and attention to detail, making sure every tattoo session is carefully executed.
          </p>
        </div>
          ...
          {[
            {
              ...
              desc: "Delicate, precise fine line tattoos and minimalist designs. Subtle and elegant body art crafted with exceptional attention to detail.",
            },
            {
              ...
              desc: "Stunning black and grey realism tattoos with incredible depth and precision. Lifelike artwork that stands the test of time.",
            },
            {
              ...
              title: "Custom Sleeve Tattoos",
              desc: "Full and half sleeve tattoos planned as cohesive works of art. Every element flows naturally to tell your unique personal story.",
            },
          ].map((s) => (
      ...
      <section className="sec-mid mx-auto w-full max-w-5xl px-4 py-24 sm:px-6 lg:px-8">
        <div className="grid gap-5 sm:grid-cols-2">
          <div className="glass rounded-2xl p-7">
            ...
            <h2 className="font-display text-xl font-bold text-white mb-5">Private Tattoo Experience in King City</h2>
            <p className="text-sm leading-relaxed text-white/60 mb-5">
              Our studio provides a focused and professional tattoo environment where clients receive
              personal attention and a comfortable experience. Each appointment is designed to give
              the artist enough time to work on detailed designs and deliver high-quality results.
            </p>
            <div className="grid grid-cols-1 gap-2">
              {[
                "Focused, personal one-on-one sessions",
                "Clean and professional studio environment",
                "Proper time allocated for detailed work",
                "Welcoming atmosphere for every client",
              ].map((item) => (
          ...
          <div className="glass rounded-2xl p-7">
            ...
            <h2 className="font-display text-xl font-bold text-white mb-5">Tattoo Consultation in King City</h2>
            <p className="text-sm leading-relaxed text-white/60 mb-4">
              Every tattoo begins with a consultation where we discuss your design ideas, placement,
              size, and style preferences. This allows us to create custom tattoos in King City that
              are carefully planned before the session begins.
            </p>
            <ul className="space-y-3">
              {[
                "Discuss your concept and vision",
                "Plan placement, size, and style",
                "Receive a detailed quote",
                "Prepare with professional guidance",
              ].map((tip, i) => (
            ...
            <div className="grid gap-0 lg:grid-cols-2">
              <div className="p-8 sm:p-12">
                ...
                <p className="mt-6 leading-relaxed text-white/55">
                  To schedule your tattoo consultation or appointment in King City, complete the form
                  and we will reply with availability, a quote range, and preparation steps.
                </p>
