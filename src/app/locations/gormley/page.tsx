...
export const metadata: Metadata = {
  title: "Tattoo in Gormley | Custom Tattoos & Professional Studio | AMAX Tattoo",
  description:
    "Professional tattoo services in Gormley, Ontario. Custom designs, fine line, black and grey, realism, and sleeve tattoos. Book your appointment at AMAX Tattoo Studio.",
  keywords: [
    "tattoo gormley ontario",
    "tattoo studio gormley",
    "tattoo shop gormley",
    "custom tattoo gormley ontario",
    "fine line tattoo gormley",
    "black and grey tattoo gormley",
    "realism tattoo gormley",
    "minimalist tattoo gormley",
    "tattoo artist gormley ontario",
    "tattoo appointment gormley",
    "professional tattoo gormley",
    "sleeve tattoo gormley",
    "tattoo near gormley ontario",
    "custom tattoo design ontario",
    "tattoo studio near whitchurch stouffville",
  ],
  alternates: { canonical: `${siteConfig.domain}/locations/gormley` },
  openGraph: {
    title: "Tattoo in Gormley | AMAX Tattoo",
    description:
      "Custom tattoos, fine line, realism, and sleeve tattoos in Gormley. Professional studio, by appointment.",
  },
};
...
export default function GormleyPage() {
  const nearbyLocations = serviceLocations.filter((l) => l.slug !== "gormley").slice(0, 6);
    ...
    <main className="w-full">
      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-3xl">
          ...
          <div className="inline-flex items-center gap-2 rounded-full border border-violet-500/25 bg-violet-500/10 px-4 py-1.5 text-[10px] font-semibold uppercase tracking-[0.3em] text-violet-400">
            ...
            Ontario, Canada · ~11 km from Aurora
          </div>
          ...
          <h1 className="font-display mt-3 text-4xl font-bold text-white sm:text-5xl lg:text-6xl leading-tight">
            Tattoo in{" "}
            <span className="gradient-text italic">Gormley</span>
          </h1>
          ...
          <p className="mt-6 mx-auto max-w-2xl leading-relaxed text-white/75">
            AMAX Tattoo Studio serves clients in Gormley with professional custom tattoo work built
            around individual ideas and artistic vision. All appointments are private and scheduled
            in advance to ensure focused, high-quality results.
          </p>
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <h2 className="font-display mt-3 text-4xl font-bold text-white sm:text-5xl">
              ...
              <span className="gradient-text italic">in Gormley</span>
            </h2>
            <p className="mt-6 leading-relaxed text-white/65">
              We offer fully custom tattoo designs for clients in Gormley, working directly with each
              person to develop original artwork. Every design is created from scratch — no generic
              templates, no reused work. Your idea drives the entire creative process.
            </p>
            <p className="mt-4 leading-relaxed text-white/50">
              From the initial concept to the finished tattoo, our artists handle every stage of the
              design process. We focus on placement, proportion, and long-term quality so your custom
              tattoo looks as good years later as it does on the day of your session.
            </p>
          </div>
      ...
      <section className="sec-dark mx-auto w-full max-w-5xl px-4 py-24 sm:px-6 lg:px-8">
        <div className="mb-12">
          ...
          <h2 className="font-display mt-3 text-4xl font-bold text-white sm:text-5xl">
            ...
            <span className="gradient-text italic">Near Gormley</span>
          </h2>
          <p className="mt-4 max-w-2xl leading-relaxed text-white/55">
            Our approach is simple: consultation, custom design, professional session, and full
            aftercare guidance. Each stage is handled with care to deliver artwork you will be proud
          ...
          {[
            {
              ...
              desc: "Delicate fine line work and refined minimalist tattoos executed with steady precision. Clean, understated, and crafted to age beautifully.",
            },
            {
              ...
              desc: "High-detail black and grey realism with smooth tonal gradients and lifelike precision. Built to maintain quality through the years.",
            },
            {
              ...
              desc: "Full and half sleeve tattoos designed as a single cohesive composition. Carefully balanced artwork that tells your story from start to finish.",
            },
          ].map((s) => (
      ...
      <section className="sec-mid mx-auto w-full max-w-5xl px-4 py-24 sm:px-6 lg:px-8">
        <div className="glass rounded-2xl p-8">
          ...
          <h2 className="font-display text-2xl font-bold text-white mb-5">Tattoo Consultation in Gormley</h2>
          <p className="leading-relaxed text-white/65 mb-4">
            Before the tattoo session, we hold a consultation to review your idea, discuss the
            design, and confirm placement and sizing. This step keeps everyone aligned and ensures
            the final result matches your vision.
          </p>
          <p className="leading-relaxed text-white/50 mb-6">
            Clients in Gormley can book their consultation online. We explain what to expect at each
            stage — from the first design review to post-session aftercare — so the process is clear
            ...
            {[
              {
                ...
                a: "Session length depends on the complexity and size of the design. Small pieces typically take 1–2 hours. Larger projects are planned across multiple sessions.",
              },
              {
                q: "Does getting a tattoo hurt?",
                a: "Discomfort varies based on the placement and the individual. Most clients find the sensation manageable. Our artists maintain a steady, comfortable pace throughout.",
              },
              {
                q: "How should I prepare for a tattoo?",
                a: "Have a solid meal before your session, stay hydrated, and wear comfortable clothing that gives access to the tattoo area. Avoid alcohol for at least 24 hours beforehand.",
              },
              {
                q: "How long does tattoo healing take?",
                a: "Surface skin heals within 2–3 weeks. Full healing of the deeper skin layers takes up to 3 months. Consistent aftercare is essential for the best long-term outcome.",
              },
            ].map((item) => (
              <div key={item.q}>
            ...
            <div className="grid gap-0 lg:grid-cols-2">
              <div className="p-8 sm:p-12">
                ...
                <p className="mt-6 leading-relaxed text-white/55">
                  ...
                  custom tattoo. Submit the form and we will get back to you with availability and a
                  price estimate.
                </p>
