...
export const metadata: Metadata = {
  title: "Tattoo in East Gwillimbury | Custom Tattoos & Professional Studio | AMAX Tattoo",
  description:
    "Professional tattoo services in East Gwillimbury, Ontario. Custom designs, fine line, black and grey, realism, and sleeve tattoos. Book your appointment at AMAX Tattoo Studio.",
  keywords: [
    "tattoo east gwillimbury",
    "tattoo studio east gwillimbury",
    "tattoo shop east gwillimbury",
    "custom tattoo east gwillimbury",
    "fine line tattoo east gwillimbury",
    "black and grey tattoo east gwillimbury",
    "realism tattoo east gwillimbury",
    "minimalist tattoo east gwillimbury",
    "tattoo artist east gwillimbury ontario",
    "tattoo appointment east gwillimbury",
    "professional tattoo east gwillimbury",
    "sleeve tattoo east gwillimbury",
    "tattoo near east gwillimbury",
    "custom tattoo design ontario",
    "tattoo studio near sharon ontario",
  ],
  alternates: { canonical: `${siteConfig.domain}/locations/east-gwillimbury` },
  openGraph: {
    title: "Tattoo in East Gwillimbury | AMAX Tattoo",
    description:
      "Custom tattoos, fine line, realism, and sleeve tattoos in East Gwillimbury. Professional studio, by appointment.",
  },
};
...
export default function EastGwillimburyPage() {
  const nearbyLocations = serviceLocations.filter((l) => l.slug !== "east-gwillimbury").slice(0, 6);
  ...
  return (
    <main className="w-full">
      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-3xl">
          ...
          <h1 className="font-display mt-3 text-4xl font-bold text-white sm:text-5xl lg:text-6xl leading-tight">
            Tattoo in{" "}
            <span className="gradient-text italic">East Gwillimbury</span>
          </h1>
          ...
          <p className="mt-6 mx-auto max-w-2xl leading-relaxed text-white/75">
            AMAX Tattoo Studio offers professional tattoo services in East Gwillimbury, bringing
            custom artwork and skilled craftsmanship directly to clients in this growing community.
            Every session is by appointment to ensure a focused, personalized experience.
          </p>
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <h2 className="font-display mt-3 text-4xl font-bold text-white sm:text-5xl">
              ...
              <span className="gradient-text italic">in East Gwillimbury</span>
            </h2>
            <p className="mt-6 leading-relaxed text-white/65">
              At AMAX Tattoo Studio, every piece starts as an original concept developed in close
              collaboration with the client. We listen carefully to your ideas, then design artwork
              that fits your body, reflects your personality, and stands the test of time.
            </p>
            <p className="mt-4 leading-relaxed text-white/50">
              Whether you have a clear vision or need help developing your concept, our artists guide
              you through the design process from the first conversation to the final session. Custom
              tattoos in East Gwillimbury are available by appointment only.
            </p>
          </div>
          <div className="glass rounded-2xl p-6 sm:p-8">
            <p className="text-xs font-semibold uppercase tracking-[0.3em] text-violet-400 mb-4">Tattoo Styles Available</p>
      ...
      <section className="sec-dark mx-auto w-full max-w-5xl px-4 py-24 sm:px-6 lg:px-8">
        <div className="mb-12">
          <p className="text-[11px] font-semibold uppercase tracking-[0.3em] text-violet-400">Tattoo Process</p>
          <h2 className="font-display mt-3 text-4xl font-bold text-white sm:text-5xl">
            Professional Tattoo Studio{" "}
            <span className="gradient-text italic">Near East Gwillimbury</span>
          </h2>
          <p className="mt-4 max-w-2xl leading-relaxed text-white/55">
            Our process is designed to make every client feel informed and comfortable at each stage.
            From consultation through design, session, and aftercare — we handle every detail with
          ...
          {[
            {
              ...
              desc: "Precise fine line tattoos and clean minimalist designs crafted with exceptional attention to detail. Subtle, elegant, and built to last.",
            },
            {
              ...
              desc: "Stunning black and grey realism with incredible depth and shading. Lifelike artwork that holds its quality for years.",
            },
            {
              ...
              desc: "Full and half sleeve tattoos designed as one cohesive composition. Each element planned carefully so the final piece flows naturally.",
            },
          ].map((s) => (
      ...
      <section className="sec-mid mx-auto w-full max-w-5xl px-4 py-24 sm:px-6 lg:px-8">
        <div className="glass rounded-2xl p-8">
          ...
          <h2 className="font-display text-2xl font-bold text-white mb-5">Tattoo Consultation in East Gwillimbury</h2>
          <p className="leading-relaxed text-white/65 mb-4">
            Every tattoo starts with a conversation. During your consultation we talk through your
            idea, preferred style, placement, and sizing. This helps us build a design that fits your
            body correctly and matches your expectations before any work begins.
          </p>
          <p className="leading-relaxed text-white/50 mb-6">
            Clients in East Gwillimbury can connect with us online or by phone to schedule their
            initial consultation. We walk you through everything — pricing, session length, and how
            to prepare so your experience is smooth from start to finish.
          </p>

          {/* FAQ */}
          <div className="mt-6 border-t border-white/[0.06] pt-6 space-y-5">
            <p className="text-[11px] font-semibold uppercase tracking-[0.3em] text-violet-400 mb-4">FAQ</p>
            {[
              {
                q: "How long does a tattoo session take?",
                a: "Session length depends on the size and complexity of the design. Small pieces may take 1–2 hours, while larger or detailed work can require multiple sessions spread over several weeks.",
              },
              {
                q: "Does getting a tattoo hurt?",
                a: "Discomfort varies by placement and individual pain tolerance. Most clients describe the sensation as manageable. Our artists work at a comfortable pace and take breaks when needed.",
              },
              {
                q: "How should I prepare for a tattoo?",
                a: "Eat a full meal before your session, stay well hydrated, wear clothing that gives easy access to the tattoo area, and avoid alcohol for at least 24 hours beforehand.",
              },
              {
                q: "How long does tattoo healing take?",
                a: "Surface healing typically takes 2–3 weeks. Full skin healing can take up to 3 months. Following proper aftercare instructions is essential for the best long-term result.",
              },
            ].map((item) => (
              <div key={item.q}>
                <p className="text-sm font-semibold text-white/80">{item.q}</p>
                <p className="mt-1 text-sm leading-relaxed text-white/50">{item.a}</p>
              </div>
            ))}
          </div>
        </div>
            ...
            <div className="grid gap-0 lg:grid-cols-2">
              <div className="p-8 sm:p-12">
                ...
                <p className="mt-6 leading-relaxed text-white/55">
                  Schedule your tattoo consultation through AMAXTATTOO.COM and start planning your
                  custom tattoo. Fill out the form and we will follow up with availability and pricing.
                </p>
