...
export const metadata: Metadata = {
  title: "Tattoo in Bradford West Gwillimbury | Custom Tattoos & Professional Studio | AMAX Tattoo",
  description:
    "Professional tattoo services in Bradford West Gwillimbury, Ontario. Custom designs, fine line, black and grey, realism, and sleeve tattoos. Book your appointment at AMAX Tattoo Studio.",
  keywords: [
    "tattoo bradford west gwillimbury",
    "tattoo studio bradford ontario",
    "tattoo shop bradford",
    "custom tattoo bradford ontario",
    "fine line tattoo bradford",
    "black and grey tattoo bradford",
    "realism tattoo bradford ontario",
    "minimalist tattoo bradford",
    "tattoo artist bradford west gwillimbury",
    "tattoo appointment bradford ontario",
    "professional tattoo bradford",
    "sleeve tattoo bradford",
    "tattoo near bradford ontario",
    "custom tattoo design ontario",
    "tattoo studio near innisfil",
  ],
  alternates: { canonical: `${siteConfig.domain}/locations/bradford` },
  openGraph: {
    title: "Tattoo in Bradford West Gwillimbury | AMAX Tattoo",
    description:
      "Custom tattoos, fine line, realism, and sleeve tattoos in Bradford West Gwillimbury. Professional studio, by appointment.",
  },
};
...
export default function BradfordPage() {
  const nearbyLocations = serviceLocations.filter((l) => l.slug !== "bradford").slice(0, 6);
    ...
    <main className="w-full">
      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-3xl">
          ...
          <div className="inline-flex items-center gap-2 rounded-full border border-violet-500/25 bg-violet-500/10 px-4 py-1.5 text-[10px] font-semibold uppercase tracking-[0.3em] text-violet-400">
            ...
            Ontario, Canada · ~20 km from Aurora
          </div>
          ...
          <h1 className="font-display mt-3 text-4xl font-bold text-white sm:text-5xl lg:text-6xl leading-tight">
            Tattoo in{" "}
            <span className="gradient-text italic">Bradford</span>
          </h1>
          ...
          <p className="mt-6 mx-auto max-w-2xl leading-relaxed text-white/75">
            AMAX Tattoo Studio provides professional tattoo services in Bradford West Gwillimbury,
            offering custom designs built around each client&apos;s ideas. We prioritize quality,
            safety, and a personal approach to every tattoo project.
          </p>
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <h2 className="font-display mt-3 text-4xl font-bold text-white sm:text-5xl">
              ...
              <span className="gradient-text italic">in Bradford</span>
            </h2>
            <p className="mt-6 leading-relaxed text-white/65">
              We create fully custom tattoos for clients in Bradford West Gwillimbury, designing each
              piece from scratch based on your ideas, preferred style, and intended placement. No
              flash designs — every tattoo is original and built specifically for you.
            </p>
            <p className="mt-4 leading-relaxed text-white/50">
              Our artists are experienced in a wide range of styles and work with you throughout
              the entire design process. We take time to understand your vision so the finished piece
      ...
      <section className="sec-dark mx-auto w-full max-w-5xl px-4 py-24 sm:px-6 lg:px-8">
        <div className="mb-12">
          ...
          <h2 className="font-display mt-3 text-4xl font-bold text-white sm:text-5xl">
            ...
            <span className="gradient-text italic">Near Bradford</span>
          </h2>
          <p className="mt-4 max-w-2xl leading-relaxed text-white/55">
            Our process covers every stage: consultation, design preparation, the tattoo session
            itself, and detailed aftercare guidance. We keep the experience straightforward and
            transparent so you always know what to expect next.
          </p>
        </div>
          ...
          {[
            {
              ...
              desc: "Clean, precise fine line work and minimalist tattoos designed with a careful eye for proportion and spacing. Timeless and refined.",
            },
            {
              ...
              desc: "Rich black and grey realism with depth, texture, and precise shading. We create portrait-quality tattoos that hold their detail over time.",
            },
            {
              ...
              desc: "Half and full sleeve tattoos planned as a unified artwork. Every element is balanced to create a design that flows naturally from shoulder to wrist.",
            },
          ].map((s) => (
      ...
      <section className="sec-mid mx-auto w-full max-w-5xl px-4 py-24 sm:px-6 lg:px-8">
        <div className="glass rounded-2xl p-8">
          ...
          <h2 className="font-display text-2xl font-bold text-white mb-5">Tattoo Consultation in Bradford West Gwillimbury</h2>
          <p className="leading-relaxed text-white/65 mb-4">
            Before any tattoo work begins, we start with a consultation to review your design idea,
            discuss placement and sizing, and align on the artistic direction. This step ensures
            both you and the artist are fully prepared before the session.
          </p>
          <p className="leading-relaxed text-white/50 mb-6">
            Clients in Bradford West Gwillimbury can book their consultation online through
            AMAXTATTOO.COM. We guide you through every detail — from what to wear to how to care
            for your tattoo in the weeks after your session.
          </p>
            ...
            {[
              {
                ...
                a: "Duration depends on the size and complexity of the design. Smaller tattoos may take 1–2 hours, while large or detailed work can be split across multiple sessions.",
              },
              {
                q: "Does getting a tattoo hurt?",
                a: "Some discomfort is normal, but the level varies by location on the body and individual sensitivity. Our artists work at a steady, comfortable pace throughout the session.",
              },
              {
                q: "How should I prepare for a tattoo?",
                a: "Eat a good meal, drink water, and get enough rest the night before. Wear clothing that provides easy access to the area being tattooed. Avoid alcohol for 24 hours prior.",
              },
              {
                q: "How long does tattoo healing take?",
                a: "The outer layers of skin typically heal within 2–3 weeks. Complete healing of the deeper skin layers can take up to 3 months with proper aftercare.",
              },
            ].map((item) => (
              <div key={item.q}>
            ...
            <div className="grid gap-0 lg:grid-cols-2">
              <div className="p-8 sm:p-12">
                ...
                <p className="mt-6 leading-relaxed text-white/55">
                  ...
                  custom tattoo. Complete the form and we will respond with availability and pricing.
                </p>
